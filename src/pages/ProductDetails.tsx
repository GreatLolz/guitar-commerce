                ...
                <div className="flex flex-row gap-5">
                    ...
                    <div className="flex flex-col w-160 gap-3">
                        ...
                        <div className="flex flex-row gap-1 w-full">
                            ...
                            <Button onClick={() => addCartItem(product.id, quantity)} className="bg-orange-600 hover:bg-orange-500 text-white p-2 px-4 rounded-sm hover:cursor-pointer font-bold w-full">Add to Cart</Button>
                        </div>
                        <div className="flex flex-col">
